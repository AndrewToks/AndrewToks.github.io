...
const page = () => {
  return (
    <div className='bg-slate-950 p-5 max-w-[1000px] ml-auto mr-auto flex justify-center items-center flex-col gap-5'>
     <h1 className='text-2xl bg-orange-200 text-orange-500 max-w-fit p-2'>Finance Tracker</h1>
    ...
    <ul className='flex flex-col gap-3'>
        ...
        <li>Technologies Used:React, Next.js, TailwindCSS and Firebase.</li>
    </ul>
    <div className='flex flex-row gap-3'>
    <button className='btn btn-primary'><a href="finance-tracker-by-andrew.vercel.app/">Live Preview</a></button>
    <button className='btn btn-primary-outline'><a href="https://github.com/AndrewToks/finance-tracker">Github</a></button>
    </div>
    </div>
  )
}
