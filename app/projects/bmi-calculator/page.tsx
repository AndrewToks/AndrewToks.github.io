...
const page = () => {
  return (
    <div className='min-h-screen bg-slate-950 p-5 max-w-[1000px] ml-auto mr-auto flex justify-center items-center flex-col gap-5'>
     <h1 className='text-2xl bg-orange-200 text-orange-500 max-w-fit p-2'>Bmi Calculator</h1>
    ...
    <button className='btn btn-primary'><a href="bmi-calculator-lake-one.vercel.app/">Live Preview</a></button>
    <button className='btn btn-primary-outline'><a href="https://github.com/AndrewToks/bmi-calculator">Github</a></button>
    </div>
    </div>
  )
}
